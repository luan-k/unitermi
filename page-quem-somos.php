...
<section class="container grid grid-cols-2">
	<div class="bg-image container" style="background-image: url(<?php echo get_theme_file_uri('assets/images/unitermi-quem-somos.jpg'); ?>); ">
	</div>
	<div class=" pl-24 font-montserrat py-60">
		...
		<a href="<?php echo esc_url(site_url('/produtos')); ?>" class="mt-20 capitalize btn-input items-center justify-center rounded-2xl py-6 px-12 text-center border-2 border-unitermi-primary-redDark text-unitermi-primary-redDark font-josefin-sans font-bold text-xl">
