  ...
  _createClass(Search, [{
    ...
    value: function getResults() {
      ...
      Jquery__WEBPACK_IMPORTED_MODULE_0___default().getJSON(WKodeData.root_url + "/wp-json/wk/v1/search?term=" + this.searchField.val(), function (results) {
        _this.resultsDiv.html("\n        <div class=\"\" >\n              ".concat(results.products.length ? '<div class="row"> <h3 class="title-3 mt-5 mb-3 text-white font-montserrat"> Produtos </h3> <hr class="white"> <div class="grid grid-cols-1 md:grid-cols-4 gap-12 px-12"> ' : '<h3 class="title-4 text-white mt-12 mb-3 text-center font-montserrat">nenhum produto corresponde a sua pesquisa</h3>', "\n                ").concat(results.products.map(function (item) {
          return "\n\t\t\t\t\t\t\t\t\t\t\t<a href=\"".concat(item.permalink, "\" class=\"products-banner-carousel-card underline-hover relative bg-white\">\n\t\t\t\t\t\t\t\t\t\t\t<div class=\"products-banner-carousel-card__img-wrapper\">\n\t\t\t\t\t\t\t\t\t\t\t\t<img class=\"products-banner-carousel-card__img-wrapper--img\"  src=\"").concat(item.image, "\" alt=\"imagem produto\">\n\t\t\t\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t\t\t\t<div class=\"products-banner-carousel-card__body pt-12 px-9 pb-6\">\n\t\t\t\t\t\t\t\t\t\t\t\t<h3 class=\"products-banner-carousel-card__body--title title-bland text-gray-600 text-2xl\">\n\t\t\t\t\t\t\t\t\t\t\t\t\t").concat(item.title, "\n\t\t\t\t\t\t\t\t\t\t\t\t</h3>\n\t\t\t\t\t\t\t\t\t\t\t</div>\n\n\t\t\t\t\t\t\t\t\t\t</a>\n                      ");
        }).join(""), "\n\t\t\t\t\t\t\t\t\t</div><div class='btn-wraper justify-center search my-5 px-9 py-6'> <a href=\"").concat(WKodeData.root_url, "/produtos\" class='btn-input items-center justify-center py-12 px-12 text-center border-2 border-unitermi-primary-redDark text-white font-montserrat font-bold text-3xl'> ver todos os Produtos </a> </div>\n              ").concat(results.products.length ? "</div>" : "", "\n          </div>\n\n\n      </div>\n      "));
...
var resetAllText = document.getElementsByClassName("wpc-filter-chip-name")[0];
