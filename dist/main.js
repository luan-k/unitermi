  ...
  _createClass(Search, [{
    ...
    value: function getResults() {
      ...
      Jquery__WEBPACK_IMPORTED_MODULE_0___default().getJSON(WKodeData.root_url + "/wp-json/wk/v1/search?term=" + this.searchField.val(), function (results) {
        _this.resultsDiv.html("\n        <div class=\"\" >\n              ".concat(results.products.length ? '<div class="row"> <h3 class="title-3 mt-5 mb-3 text-white"> Produtos </h3> <hr class="white"> <div class="grid grid-cols-1 md:grid-cols-4 gap-12 px-12"> ' : '<h3 class="title-4 text-white mt-5 mb-3 text-center">nenhum produto corresponde a sua pesquisa</h3>', "\n                ").concat(results.products.map(function (item) {
          return "\n\t\t\t\t\t\t\t\t\t\t\t<a href=\"".concat(item.permalink, "\" class=\"products-banner-carousel-card underline-hover rounded-md relative bg-white\">\n\t\t\t\t\t\t\t\t\t\t\t<div class=\"products-banner-carousel-card__img-wrapper\">\n\t\t\t\t\t\t\t\t\t\t\t\t<img class=\"products-banner-carousel-card__img-wrapper--img\"  src=\"").concat(item.image, "\" alt=\"imagem produto\">\n\t\t\t\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t\t\t\t<div class=\"products-banner-carousel-card__body pt-12 px-9 pb-9\">\n\t\t\t\t\t\t\t\t\t\t\t\t<h3 class=\"products-banner-carousel-card__body--title title-bland text-gray-600 text-2xl mb-3\">\n\t\t\t\t\t\t\t\t\t\t\t\t\t").concat(item.title, "\n\t\t\t\t\t\t\t\t\t\t\t\t</h3>\n\t\t\t\t\t\t\t\t\t\t\t</div>\n\n\t\t\t\t\t\t\t\t\t\t</a>\n                      ");
        }).join(""), "\n\t\t\t\t\t\t\t\t\t</div><div class='btn-wraper justify-center search my-5 px-9 py-6 rounded-2xl'> <a href=\"").concat(WKodeData.root_url, "/produtos\" class='btn-wk text-center px-9 py-6 rounded-2xl bg-white text-dark-primary'> ver todos os Produtos </a> </div>\n              ").concat(results.products.length ? "</div>" : "", "\n          </div>\n\n\n      </div>\n      "));
...
var pxAccordion = function pxAccordion(elementSelector) {
...
var pxAccordionInit = function pxAccordionInit(element) {
  var selectedElement = element;
  var accHeads = selectedElement.querySelectorAll(".px-acc-item .px-acc-head");
  accHeads.forEach(function (headItem) {
    headItem.addEventListener("click", function (event) {
      var accItem = event.target.parentElement;
      var accBody = event.target.nextElementSibling;
...
/* harmony import */ var _modules_slider_next__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/slider-next */ "./scripts/modules/slider-next.js");
/* harmony import */ var _modules_slider_next__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_modules_slider_next__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var _modules_counter__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/counter */ "./scripts/modules/counter.js");
/* harmony import */ var _modules_counter__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(_modules_counter__WEBPACK_IMPORTED_MODULE_8__);
...
/* harmony import */ var _modules_slick_config_product_slider__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/slick-config/product-slider */ "./scripts/modules/slick-config/product-slider.js");
/* harmony import */ var _modules_Search__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/Search */ "./scripts/modules/Search.js");
...
var search = new _modules_Search__WEBPACK_IMPORTED_MODULE_11__["default"]();
...
jquery__WEBPACK_IMPORTED_MODULE_1___default()(function () {
  var links = jquery__WEBPACK_IMPORTED_MODULE_1___default()('.woocommerce-breadcrumb > a');
