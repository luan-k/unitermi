  ...
  _createClass(Search, [{
    ...
    value: function getResults() {
      ...
      Jquery__WEBPACK_IMPORTED_MODULE_0___default().getJSON(WKodeData.root_url + "/wp-json/wk/v1/search?term=" + this.searchField.val(), function (results) {
        _this.resultsDiv.html("\n      <div class=\"\" >\n        \n          ".concat(results.postsArray.length ? '<div class="row"> <h3 class="title-3 mt-5 mb-3 text-white"> Produtos </h3> <hr class="white">' : '<h3 class="title-4 text-white mt-5 mb-3 text-center">nenhum produto corresponde a sua pesquisa</h3>', "\n            ").concat(results.postsArray.map(function (item) {
          return "\n                  <a href=\"".concat(item.permalink, "\" class=\"link-search-results grid grid-cols-1\">\n                      <div class=\"col-12 search-product-wraper grid grid-cols-1\">\n                        <div class=\"row grid grid-cols-1 md:grid-cols-12\">\n                          <div class=\"col-12 col-sm-4 col-img-search md:col-span-4\">\n                              <div class=\"img-wraper-search\">\n                                  <img src=\"").concat(item.image, "\" alt=\"\">\n                              </div>\n                          </div>\n                          <div class=\"col-12 col-sm-8 col-text-search md:col-span-8\">\n                              <div class=\"row grid grid-cols-1 md:grid-cols-12\">\n                                  <div class=\"col-12 col-sm-8 title-3 title-search md:col-span-12\">").concat(item.title, "</div>\n                                  \n                              </div>\n                              <div class=\"col-12 text-search hidden md:grid grid-cols-1\">").concat(item.descricao, "</div>\n                          </div>\n                        </div>\n                      </div>\n                  </a>                \n                  ");
        }).join(""), "\n              <div class='btn-wraper justify-center search my-5 px-9 py-6 rounded-2xl'> <a href=\"").concat(WKodeData.root_url, "/produtos\" class='btn-wk text-center px-9 py-6 rounded-2xl bg-white text-dark-primary'> ver todos os Produtos </a> </div> \n          ").concat(results.postsArray.length ? "</div>" : "", "\n        </div>\n        <div class=\"\">\n            ").concat(results.servicos.length ? '<div class="row"> <h3 class="title-3 mt-5 mb-3 text-white"> Serviços </h3> <hr class="white">' : '<h3 class="title-4 text-white mt-5 mb-3 justify-center text-center">nenhum serviço corresponde a sua pesquisa</h3>', "\n              ").concat(results.servicos.map(function (item) {
          return "\n                    <a href=\"".concat(item.permalink, "\" class=\"link-search-results servico grid grid-cols-1\">\n                        <div class=\"col-12 search-product-wraper grid grid-cols-1\">\n                          <div class=\"row grid grid-cols-1 md:grid-cols-12\">\n                            <div class=\"col-12 col-sm-4 col-img-search md:col-span-4\">\n                                <div class=\"img-wraper-search\">\n                                    <img src=\"").concat(item.image, "\" alt=\"\">\n                                </div>\n                            </div>\n                            <div class=\"col-12 col-sm-8 col-text-search md:col-span-8\">\n                                <div class=\"row\">\n                                    <div class=\"col-12 title-3 title-search grid grid-cols-1\">").concat(item.title, "</div>\n                                    \n                                </div>\n                                <div class=\"col-12 text-search grid-cols-1 hidden md:grid\">").concat(item.descricao, "</div>\n                            </div>\n                          </div>\n                        </div>\n                    </a>\n                    ");
        }).join(""), "\n                <div class='btn-wraper justify-center search my-5 px-9 py-6 rounded-2xl'> <a href=\"").concat(WKodeData.root_url, "/servicos\" class='btn-wk text-center text-white px-9 py-6 rounded-2xl bg-dark-primary'> ver todos os servi\xE7os </a> </div> \n            ").concat(results.servicos.length ? "</div>" : "", "\n        </div>\n        \n      </div>\n      "));
